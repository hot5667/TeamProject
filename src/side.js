    ...
    function renderTeamInfo(container, data, targetId) {
        ...
        if (targetId === "KimDohyun-section") {
            ...
            <div class = "ChoHeeJin-text">
                <p>
                    뽀송 털, 발 꼬순내, 검정콩 세개 진짜 너무 귀여워요..!! 🐶<br>
                    <br>
                    가끔 들을 수 있는 발 톡톡 소리랑 물 마시는 소리도 너무 좋아요! 그리고 저는 아이돌 인피니트도 좋아해요! 🎤<br>
                    <br>
                    아 최근에는 무한대집회 IV 팬미팅에 갔다왔어요! 콘서트랑 팬미팅은 비싸지만 너무 재미있어요..!! <br>
                    <br>
                    또, 제가 유일하게 하는 게임은 스타크래프트에요! 다들 한몰 간 게임이라고 하지만 저는 아직 재밌더라구요 유즈맵도 계속 업데이트 되고있고 재밌는 맵도 계속 나오고 있어서요! 🎮<br>
                    <br>
                    사실 제가 할 줄 아는 유일한 게임이에요 ㅋㅋ<br>
                </p>
            </div>
            `;
            ...
            <div class = "HanSuBin-text">
                ...
                <p>
                    ...
                    그런  저에게  소확행은  팀원분들과  회의하며  피드백  주고받는  것.  유일한  휴식  타임이랄까요?  (물론,  저는  피드백 받는  입장이지만요.^^) <br>
                    <br>
            ...
            <div class = "JanSungHyun-text">
                <p>
                    ...
                    <br>
                    사람들과의 대화보다는 혼자 있는 시간을 더 즐기는 편입니다. <br>
                    <br>
                    일상 속에서는 종종 게으름을 피우곤 하지만, 관심 있는 분야나 좋아하는 일에는 깊이 몰두하는 순간도 있습니다.<br>
                    <br>
                    좋아하는 것은 캠핑을 좋아합니다. 자주 가거나 멋있는 장비가 있지는 않지만 다녀오면 스트레스가 많이 풀리는 것 같습니다.<br>
                </p>   
            </div>
            `;
        }
